...
export class updateEnum1638114987072 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."pos_country_enum" AS ENUM('AE', 'AT', 'AU', 'BA', 'BE', 'BG', 'BY', 'CA', 'CH', 'DE', 'DK', 'EE', 'ES', 'FI', 'FR', 'GE', 'GR', 'GT', 'HN', 'HR', 'ID', 'IE', 'IT', 'LT', 'MA', 'MT', 'MU', 'MY', 'NI', 'NL', 'NO', 'PK', 'PL', 'PT', 'PY', 'RE', 'RO', 'RS', 'SAR', 'SE', 'SI', 'SV', 'TH', 'UA', 'UK', 'UNKNOWN', 'US', 'VN')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."pos_country_enum_old" AS ENUM('AE', 'AT', 'BA', 'BE', 'BG', 'BY', 'CA', 'CH', 'DE', 'DK', 'EE', 'ES', 'FI', 'FR', 'GE', 'GR', 'GT', 'HN', 'HR', 'ID', 'IE', 'IT', 'LT', 'MA', 'MT', 'MU', 'MY', 'NI', 'NL', 'NO', 'PK', 'PL', 'PT', 'PY', 'RE', 'RO', 'RS', 'SAR', 'SE', 'SI', 'SV', 'TH', 'UA', 'UK', 'UNKNOWN', 'US', 'VN')`);
        await queryRunner.query(`ALTER TABLE "pos" ALTER COLUMN "country" DROP DEFAULT`);
